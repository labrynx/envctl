...
def plan_remove(
    ...
    with observe_span(
        ...
        span_fields["present_in_other_profile_count"] = len(other_profiles)
...
def run_remove(
    ...
    with observe_span(
        ...
        span_fields["removed"] = True
        span_fields["removed_profile_count"] = len(removed_from_profiles)
