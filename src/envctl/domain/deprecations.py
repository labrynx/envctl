...
def make_group_deprecation_warning(key: str, value: str) -> ContractDeprecationWarning:
    ...
    return ContractDeprecationWarning(
        ...
        message=(
            ...
            "but you should migrate to 'groups' with an array of values."
        ),
    )
...
def make_required_deprecation_warning(key: str) -> ContractDeprecationWarning:
    ...
    return ContractDeprecationWarning(
        ...
        message=(
            ...
            "This key no longer has meaning and will be ignored. Validation is now driven "
            "by the active contract scope (full contract, --set, --group, or --var)."
        ),
    )
