...
from envctl.cli.serializers import emit_json, serialize_doctor_checks, serialize_inspect_result
        ...
        emit_json(
            build_json_command_payload(
                ...
                data={
                    ...
                    **serialize_doctor_checks(build_doctor_legacy_checks(result)),
                },
