...
hooks_app = create_typer_app(
    ...
    lazy_subcommands={
        "status": {
            "import_path": "envctl.cli.commands.hooks.commands.status:hooks_status_command",
            "short_help": "Show managed hooks status.",
        },
        "install": {
            "import_path": "envctl.cli.commands.hooks.commands.install:hooks_install_command",
            "short_help": "Install envctl-managed hooks.",
        },
        "repair": {
            "import_path": "envctl.cli.commands.hooks.commands.repair:hooks_repair_command",
            "short_help": "Repair envctl-managed hooks.",
        },
        "remove": {
            "import_path": "envctl.cli.commands.hooks.commands.remove:hooks_remove_command",
