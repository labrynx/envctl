...
def test_run_export_returns_shell_lines_for_active_profile_by_default(
    ...
    _context, active_profile, rendered, warnings = export_service.run_export("staging")
...
def test_run_export_returns_dotenv_without_header(
    ...
    _context, active_profile, rendered, warnings = export_service.run_export(
        "staging",
        format="dotenv",
    )
...
def test_run_export_projects_only_selected_group(
    ...
    _context, _profile, rendered, _warnings = export_service.run_export(
        "staging",
        format="dotenv",
