...
from envctl.cli.prompts.input import confirm, prompt_secret, prompt_string
...
def test_prompt_secret_uses_getpass_for_secret_with_user_value(
    ...
    monkeypatch.setattr(
        "envctl.cli.prompts.input.getpass.getpass",
...
def test_prompt_string_uses_typer_prompt_for_non_secret(
    ...
    monkeypatch.setattr("envctl.cli.prompts.input.typer.prompt", fake_prompt)
...
def test_typer_confirm_passes_correct_arguments(
    ...
    monkeypatch.setattr("envctl.cli.prompts.input.typer.confirm", fake_confirm)
