...
def test_doctor_reports_repo_detection_warn_outside_git_repo(isolated_env, tmp_path, monkeypatch) -> None:
...
def test_doctor_reports_repo_detection_ok_inside_git_repo(isolated_env, repo_dir, monkeypatch) -> None:
